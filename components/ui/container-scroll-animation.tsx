        ...
        {users.map((user, idx: number) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <h2 className=" text-gray-500 text-xs pb-2">{user.designation}</h2>
              <a href={user.href} className="border border-foreground/20 rounded-md px-1 py-1 text-foreground">Coming Soon</a>
            </div>
          </motion.div>
        ))}
      </div>
